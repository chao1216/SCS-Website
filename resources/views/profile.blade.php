...
@section('body')
    ...
    <div ng-app="profileApp">
        ...
        <div ng-controller="ProfileController">
            ...
            <div>
                <div style="" class="panel-heading"><h3 class="panel-heading"><strong>@{{ profile.name }}'s Profile</strong></h3></div>
                <img style="float: left;" class="img-thumbnail" src="https://static1.squarespace.com/static/5134cbefe4b0c6fb04df8065/t/571e020b27d4bd683be083f8/1461584400006/?format=300w" alt="">
